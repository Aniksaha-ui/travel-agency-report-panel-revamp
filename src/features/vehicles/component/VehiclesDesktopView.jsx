...
import { vehicleColumns } from "./vehiclesView.config";

export default function VehiclesDesktopView({
  boardDate,
  copy,
  handleSearchChange,
  isLoading,
        ...
        <div className="container-xl">
          <div className="trip-performance-hero">
            <div className="trip-performance-hero__copy">
              <span className="trip-performance-hero__eyebrow">/admin/vehicles</span>
            ...
            <div className="trip-performance-hero__meta">
              ...
              <div className="trip-performance-hero__meta-item">
                <span className="trip-performance-hero__meta-label">Visible seats</span>
                <strong>{summary.totalSeatCapacityLabel ?? "0"}</strong>
              </div>
              <div className="trip-performance-hero__meta-item">
        ...
        <div className="container-xl">
          ...
          <section className="dashboard-section">
            <Card
              ...
              subtitle="Vehicle names, types, seat totals, and route assignments from the admin vehicle catalog."
            ...
            >
              {isLoading && !vehicles.length ? (
                <div className="p-4 text-center text-secondary">Loading vehicles...</div>
              ) : (
                <Table
                  columns={vehicleColumns}
                  data={vehicles}
                  emptyTitle="No vehicles found"
                  emptyDescription="No vehicle rows matched the current search."
                />
              )}
            </Card>
          </section>
